class Line extends Shape
{
                    ...
                    for(let i = 0; i < this.handles.length; i++)
                    {
                         ...
                         {    
                              s.canvas.onmousemove = (e) => {
                                   ...
                                   console.log("3************ SELECTING AND MOVING SHAPE")
                              ...
                              s.canvas.onmouseup = () => {
                                   console.log("4************ FIRST SHAPE SELECTED");
     ...
     translate()
     {
          ...
          {
               console.log("7************ CURRENT SHAPE TO PREVIOUS SHAPE");
               ...
               s.canvas.onmousedown = (e) => {
                    ...
                    for(let i = 0; i < this.handles.length; i++)
                    {
                         if(Math.sqrt(Math.pow(startX - this.handles[i].x, 2) + Math.pow(startY - this.handles[i].y, 2)) < this.handleSize)
                         {
                              ...
                              s.canvas.onmouseup = () => {
                                   console.log("10************ FINISHED MOVING SHAPE");
                                   s.canvas.onmousemove = undefined;
                                   // s.drawAll();
                              }
                         }
                         ...
                         {
                              console.log("DESELECTING SHAPE? ***************************");

                              s.canvas.onmouseup = () => {
                                   console.log("UNSELECTING SHAPE*************************");
                                   s.canvas.onmousemove = undefined;
          ...
          {
               console.log("MOVING THE SAME SHAPE 2");
               ...
               s.canvas.onmousedown = (e) => {
                    ...
                    for(let i = 0; i < this.handles.length; i++)
                    {
                         if(Math.sqrt(Math.pow(startX - this.handles[i].x, 2) + Math.pow(startY - this.handles[i].y, 2)) < this.handleSize)
                         {
                              ...
                              s.canvas.onmouseup = () => {
                                   console.log("10000************ FINISHED MOVING SHAPE");
                                   s.canvas.onmousemove = undefined;
                                   // s.drawAll();
                              }
                         }
                         ...
                         {
                              console.log("DESELECTING SHAPE? 22222***************************");

                              s.canvas.onmouseup = () => {
                                   console.log("UNSELECTING SHAPE 22222*************************");
                                   s.canvas.onmousemove = undefined;
