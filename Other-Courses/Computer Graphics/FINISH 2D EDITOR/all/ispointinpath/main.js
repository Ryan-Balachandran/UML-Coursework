onload = () => {
     ...
     s.menubtns[6].onclick = function () 
     {
          ...
          {
               s.copyArray = { ...s.shapeArray };

               console.log("SHAPE[0]: ", s.shapeArray);
               console.log("COPY: ", s.copyArray[0]);
          }
     }
     ...
     s.menubtns[7].onclick = function () 
     {
          ...
          switch(s.copyArray[0].type)
          {
               ...
               case "Circle": 
                    s.copyArray[0].centerX += 30;
                    s.copyArray[0].centerY += 30;
                    console.log("5");
               break;
               ...
               case "Ellipse": 
                    s.copyArray[0].centerX += 30;
                    s.copyArray[0].centerY += 30;
                    s.copyArray[0].radiusX += 30;
                    s.copyArray[0].radius += 30;
                    console.log("7");
               break;
