...
function saveDragon() {
     ...
     let species = dragonForm["species"].value;
     let age = dragonForm["age"].value;
     let wings = dragonForm["wings"].value;
     let legs = dragonForm["legs"].value;
     let wingPair = dragonForm["wingPair"].value;
     let eggs = dragonForm["eggs"].value;
     let scale = dragonForm["scale"].value;
     let height = dragonForm["height"].value;
     
     let myDragon = new dragon(species, age, wings, legs, wingPair, eggs, scale, height);
     ...
     // fs.writeFile('myDragon.txt', data, (err) => {
     //      // In case of a error throw err.
     //      if (err) throw err;
     // })

     let JSONstring = JSON.stringify(myDragon);
     console.log("Dragon JSON string: " + JSONstring);

     dragons.push(JSONstring);
     console.log("Array of dragons objects: ", dragons);
}
