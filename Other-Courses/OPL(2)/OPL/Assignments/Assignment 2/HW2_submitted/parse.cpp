...
//    "Rel", "equiv", "notEquiv", "lt", "gt", "ltEquiv",
//    "gtEquiv", "if", "fi", "do", "od", "check"};

const string token_names[] = {"\"check\"", "\"read\"", "\"write\"", "id", "literal", "\"gets\"",
    "\"if\"", "\"fi\"", "\"do\"", "\"od\"", "\"==\"", "\"<>\"",
    "\"<\"", "\">\"", "\"<=\"","\">=\"","\"+\"", "\"-\"",
    "\"*\"", "\"/\"", "\"(\"", "\")\"", "\"eof\"", "\"eps\""};
...
string stmt()
{
    ...
    catch(string expr)
    {
        ...
        {
            cout << " Not expecting " << token_names[input_token] << " in " << expr << endl;
        }
...
string relation()
{
    ...
    catch(string e)
    {
        ...
        if(e == "match")
        {
            cout <<" Not expecting " << token_names[input_token] << " in Relation" << endl;
        }
        else
        {
