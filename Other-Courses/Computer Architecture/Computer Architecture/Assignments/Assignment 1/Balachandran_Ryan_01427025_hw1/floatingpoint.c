/*
 ...
 references:
 IEEE floating point: https://www.h-schmidt.net/FloatConverter/IEEE754.html
 C format specifiers: http://www.cplusplus.com/reference/cstdio/printf/
 */
...
int main(int argc, char * argv[])
{
    ...
    // put the entire process into a loop:
    for(int i = 0; i < 10; i++)
    {
        ...
        printf("\n Mantissa: %-#13x or: ", float_32.f_bits.mantissa);
        
        if(float_32.f_bits.sign == 1)
        {
            printf("     1 0");
        }
        else
        ...
        printf("\n");
        printf(" Exponent: %-#13x or: ", float_32.f_bits.exponent);
        ...
        printf("\n");
        printf("     Sign: %-#13x or: ", float_32.f_bits.sign);
        printf("     ");
        
        printf("%-8u", float_32.f_bits.sign);
        printf("\n");
        printf("in base10: %-#13g or: ", float_32.floating_value_in_32_bits);
        printf("     ");
